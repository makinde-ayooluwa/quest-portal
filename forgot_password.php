...
<head>
    ...
    <title>Forgot Password - Quest Portal</title>
    <style>
        .preloader {
            position: fixed;
            top: 0;
...
<body class="">
    ...
    <div id="main-content" class="justify-content-center align-items-center">
        <div class="container form-container shadow-lg">
            ...
            <div class="my-1">
                <form action="forgot_password_handler.php" id="forgot_form" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <input class="btn btn-sm px-4 py-2 btn-success fw-bolder" name="submit" type="submit" value="SEND RESET LINK">
                            </div>
                        </div>
                    </div>
                </form>
