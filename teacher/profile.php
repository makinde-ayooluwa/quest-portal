...
include "teacher_includes/teacher.inc.php"; // sets $teacher and other dashboard variables
...
<head>
    ...
    <title>Teacher Profile - Quest Schools</title>
    <style>
        * {
    ...
    <div class="container-fluid">
        ...
        <div class="profile-card">
            ...
            <div class="d-flex gap-4 align-items-center">
                <div>
                    <img src="<?php echo htmlspecialchars($teacherData['picture'] ?? 'assets/images/quest.jpg'); ?>" alt="avatar" class="profile-avatar">
                </div>
                <div class="flex-grow-1">
                    <h3 class="mb-1"><?php echo htmlspecialchars($teacherData['fullname'] ?? 'Teacher'); ?></h3>
                    <p class="text-muted mb-1"><?php echo htmlspecialchars($teacherData['email'] ?? ''); ?></p>
                    <p class="mb-1"><span class="badge bg-primary"><?php echo htmlspecialchars($teacherData['staff_role'] ?? 'Teacher'); ?></span></p>
                    <div class="mt-3">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h5>Contact</h5>
                    <p><strong>Phone:</strong> <?php echo htmlspecialchars($teacherData['phone'] ?? 'Not set'); ?></p>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="fullname" class="form-control" value="<?php echo htmlspecialchars($teacherData['fullname'] ?? ''); ?>" required>
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mt-3 text-center">
                                    <img src="<?php echo htmlspecialchars($teacherData['picture'] ?? 'assets/images/quest.jpg'); ?>" alt="preview" class="rounded" style="max-width:100px;">
                                </div>
                            </div>
                        </div>
                    </div>
