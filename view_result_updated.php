                    ...
                    <?php if ($hasGoogleSheetData): ?>
                        ...
                        <div class="result-card mb-4">
                            <div class="result-header">
                                <h5 class="mb-0"><i class="bi bi-table me-2"></i>Academic Results</h5>
                            ...
                            <?php foreach ($dbResults as $result): ?>
                                <div class="col-12">
                                    <div class="result-card">
                                        <div class="result-header">
                                            <h5 class="mb-0"><i class="bi bi-calendar-event me-2"></i><?php echo htmlspecialchars($result["academic_term"]); ?></h5>
