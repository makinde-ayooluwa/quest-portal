        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="profile-card">
                    <div class="profile-header d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            <img data-bs-toggle="modal" data-bs-target="#pictureChange"
                                src="<?php echo $studentData['picture']; ?>" alt="Student Avatar"
                            ...
                            <p class="mb-0 text-muted">Class: <span
                                    class="badge badge-modern text-primary badge-secondary"><?php echo $studentData['class']; ?></span>
                            </p>
                        </div>
                    ...
                    <button data-bs-toggle="modal" data-bs-target="#passwordChange" class="btn btn-primary">Change
                        password</button>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="info-item"><span class="info-label">Date of Birth:</span><span
                                    class="info-value"><?php echo $studentData['dob']; ?></span></div>
                            <div class="info-item"><span class="info-label">Gender:</span><span
                                    class="info-value"><?php echo $studentData['gender']; ?></span></div>
                            <div class="col-md-6">
                                <div class="info-item"><span class="info-label">Email:</span><span
                                        class="info-value"><?php echo $studentData['email']; ?></span></div>
                                <div class="info-item"><span class="info-label">Phone:</span><span
                                        class="info-value"><?php echo $studentData['phone']; ?></span></div>
                                <div class="col-md-12">
                                    <div class="info-item"><span class="info-label">Address:</span><span
                                            class="info-value"><?php echo $studentData['home_address']; ?></span></div>
                                </div>

                                <div class="section-title-profile"><i class="bi bi-people-fill text-green"></i>Guardian
                                    Information</div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="guardian-card">
                                            ...
                                            <div class="info-item"><span class="info-label">Name:</span><span
                                                    class="info-value"><?php echo $studentData['mother_name']; ?></span>
                                            </div>
                                            <div class="info-item"><span class="info-label">Phone:</span><span
                                                    class="info-value"><?php echo $studentData['mother_phone']; ?></span>
                                            </div>
                                            <div class="info-item"><span class="info-label">Email:</span><span
                                                    class="info-value"><?php echo $studentData['mother_email']; ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="guardian-card">
                                                ...
                                                <div class="info-item"><span class="info-label">Name:</span><span
                                                        class="info-value"><?php echo $studentData['father_name']; ?></span>
                                                </div>
                                                <div class="info-item"><span class="info-label">Phone:</span><span
                                                        class="info-value"><?php echo $studentData['father_phone']; ?></span>
                                                </div>
                                                <div class="info-item"><span class="info-label">Email:</span><span
                                                        class="info-value"><?php echo $studentData['father_email']; ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
