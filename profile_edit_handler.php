...
if ( empty($gender) || empty($phone) || empty($home_address) || empty($father_name) || empty($father_phone) || empty($father_email) || empty($mother_name) || empty($mother_phone) || empty($mother_email)) {
